...
const UserDashboardLayout = () => {
  ...
  return (
    <main className='w-full h-fit py-20 flex items-start justify-start flex-nowrap gap-10 px-10'>

        <aside className='w-60 h-fit grid border-r border-zinc-300'>
            <Link to='/account' className={location?.pathname === '/account' ? 'w-full h-fit py-3 whitespace-nowrap flex items-center pl-2 gap-3 font-medium bg-trendygreen text-white border-b border-zinc-200' : "w-[98%] h-fit py-3 whitespace-nowrap flex items-center pl-2 gap-3 font-medium text-darkgray hover:bg-verylighttrendygreen hover:border-zinc-200 border-b border-zinc-200"}>
                <RiDashboardFill />
                Dashboard 
            </Link>
            <NavLink to='/account/orders' className={({isActive}) => isActive ? 'w-full h-fit py-3 whitespace-nowrap flex items-center pl-2 gap-3 font-medium bg-trendygreen text-white border-b border-zinc-200' : "w-[98%] h-fit py-3 whitespace-nowrap flex items-center pl-2 gap-3 font-medium text-darkgray hover:bg-verylighttrendygreen hover:border-zinc-200 border-b border-zinc-200"}>
                <RiFileList2Fill />
                Orders history
            </NavLink>
            <NavLink to='/account/wishlist' className={({isActive}) => isActive ? 'w-full h-fit py-3 whitespace-nowrap flex items-center pl-2 gap-3 font-medium bg-trendygreen text-white border-b border-zinc-200' : "w-[98%] h-fit py-3 whitespace-nowrap flex items-center pl-2 gap-3 font-medium text-darkgray hover:bg-verylighttrendygreen hover:border-zinc-200 border-b border-zinc-200"}>
                <FaHeart />
                Wishlist
            </NavLink>
            <NavLink to='/account/settings' className={({isActive}) => isActive ? 'w-full h-fit py-3 whitespace-nowrap flex items-center pl-2 gap-3 font-medium bg-trendygreen text-white border-b border-zinc-200' : "w-[98%] h-fit py-3 whitespace-nowrap flex items-center pl-2 gap-3 font-medium text-darkgray hover:bg-verylighttrendygreen hover:border-zinc-200 border-b border-zinc-200"}>
                <IoMdSettings />
                Settings
            </NavLink>
