import whiteCoat from '../assets/product.webp'
...
const FeaturedSection = () => {
  return (
    <div className='mb-32 py-20 w-full h-fit flex flex-nowrap justify-center gap-10 items-center bg-verylighttrendygreen'>
        <img src={whiteCoat} alt="" className="w-1/5 h-auto" />
        <div className="w-1/4 h-fit grid">
            ...
            <Link to="/products/product-name" className="bg-trendygreen rounded shadow-tgreen px-5 py-2 mt-5 w-fit h-fit text-white font-medium">View Product</Link>
        </div>
    </div>
  )
}
