...
const ProductDetails = () => {
    ...
    const [Rating, setRating] = useState<number | undefined>(3.2)
    ...
    const handleAddToWishlist = () => {
        ...
        if(Wishlist){
            ...
            wishlistButtonRef.current?.classList.remove('animate');
            
            wishlistButtonRef.current?.classList.add('animate');
  ...
  return (
    <div className='h-fit w-full py-20 flex flex-nowrap justify-center gap-10 items-start'>
        ...
        <div className='w-4/12 h-fit grid place-items-start'>
            ...
            <h2 className='font-bold text-lg'>  $88.00</h2>
            ...
            <div className='w-full h-fit flex flex-nowrap justify-start items-center gap-10 text-sm text-zinc-600 mb-5'>
                ...
                <button className='text-darkertrendygreen underline'>
                    Leave your own review
                </button>

            </div>

            <button ref={wishlistButtonRef} className='bubbly-button w-fit h-fit whitespace-nowrap flex flex-nowrap items-center gap-2 font-medium mb-3' onClick={() => handleAddToWishlist()}>
                {Wishlist ? 
            ...
            <p className='font-bold mb-1 text-darkertrendygreen'>PANTS</p>
            ...
            <p className='font-bold mb-1 mt-7 text-darkertrendygreen'>SIZE</p>
            <div className='w-fit h-fit flex flex-nowrap justify-start items-center gap-2'>
            ...
            <p className='font-bold mb-1 mt-7 text-darkertrendygreen'>LENGTH</p>
            <div className='w-fit h-fit flex flex-nowrap justify-start items-center gap-2'>
